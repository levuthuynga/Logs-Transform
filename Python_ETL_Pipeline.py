...
##spark= SparkSession.builder.config('spark.jars.packages','com.datastax.spark:spark-cassandra-connector_2.12:3.1.0').config("spark.jars", "/home/jovyan/work/mysql-connector-j-8.0.33.jar").getOrCreate()

spark = SparkSession.builder.config("spark.cassandra.connection.host", "cassandra").config("spark.cassandra.connection.port", "9042").getOrCreate()
